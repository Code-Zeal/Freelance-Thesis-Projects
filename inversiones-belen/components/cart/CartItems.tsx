		...
		<>
			<div className='cart-items'>
				<div className='cart-items__thead row'>
					...
					<div className='cart-items__thead-cell col-md-2'>Cant</div>
				...
				<div className='cart-items__total-row row'>
					<div className='cart-items__total-cell cart-items__total-cell_title col-md-6'>Total del pedido:</div>
					<div className='cart-items__total-cell col-md-2'>
						<span className='cart-items__label'>Cant: </span>
						{total.qty}
					</div>
					<div className='cart-items__total-cell col-md-2'>
			...
			<div className='cart-items__actions'>
				...
				>
					Pasar por caja <FontAwesomeIcon icon={faShoppingCart} />
				</button>
			</div>
		</>
	);
