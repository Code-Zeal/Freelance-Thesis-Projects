...
const sortFields = [
	{id: 1, title: 'Por defecto', order: false, alias: 'default'},
	{id: 2, title: 'Por nombre', order: true, alias: 'title'},
	{id: 3, title: 'Por precio', order: true, alias: 'price'},
];
...
export default function SortButtons({params, onSort, className}: {params: TQuery, onSort: (query: TQuery) => void, className?: string}) {
	...
	return (
		<div className={clsx('sort-buttons', className)}>
			<label className='small me-2'>Ordenar:</label>
