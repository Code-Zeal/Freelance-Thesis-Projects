			...
			<div className='container'>
				<div className='row'>
					...
					<div className='col-md-8 col-lg-9'>
						...
						<h1 className='page-heading page-heading_h1  page-heading_m-h1 text-black'>{category.title}</h1>
						...
						{collection && <>
							...
							<ProductsList
								...
								query={productsQuery}
								categoryId={category.category_id === 115?117: category.category_id}
								secondCategoryId={category.category_id === 115?118:0}
