...
const detenerContador = () => {
  ...
  localStorage.setItem("level2-2", `${min} minutos y ${seg} segundos`);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  nextBtn.addEventListener("click", function () {
    ipcRenderer.send("navigate", "niveles/Nivel_3/nivel3-1.html");
  });
...
window.addEventListener("load", function () {
  ...
  const imagePath = path.join(__dirname, "level2-2.jpeg"); // Cambia la ruta según sea necesario.
