...
const detenerContador = () => {
  ...
  localStorage.setItem("level4-2", `${min} minutos y ${seg} segundos`);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  nextBtn.addEventListener("click", function () {
    ipcRenderer.send("navigate", "niveles/Ganar/ganar.html");
  });
...
window.addEventListener("load", function () {
  ...
  const imagePath = path.join(__dirname, "level4-2.jpeg"); // Cambia la ruta según sea necesario.
