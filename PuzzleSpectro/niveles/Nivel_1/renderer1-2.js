...
const detenerContador = () => {
  ...
  localStorage.setItem("level1-2", `${min} minutos y ${seg} segundos`);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  nextBtn.addEventListener("click", function () {
    ipcRenderer.send("navigate", "niveles/Nivel_2/nivel2-1.html");
  });
...
window.addEventListener("load", function () {
  ...
  const imagePath = path.join(__dirname, "level1-2.jpeg"); // Cambia la ruta según sea necesario.
