...
function ItemContent({name,image,path,data}) {
  ...
  return (
    <div class="hover:cursor-pointer flex flex-col group bg-[#171717]  border shadow-sm rounded-xl overflow-hidden hover:shadow-lg transition w-[25%] mx-[2.5%] h-auto my-2" onClick={()=>navigate("/teacherDashboard/"+path,{state:data})}>
