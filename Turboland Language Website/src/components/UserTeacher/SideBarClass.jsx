...
function SideBarClass({classrooms,setShow,classroomQuery,navigate}) {
  ...
  <div class="p-4 border-y-2 border-[#fff]">
    <h2 class="flex-none text-xl font-semibold text-[#fff]" aria-label="Brand">Tus clases</h2>
  </div>
  <nav class="hs-accordion-group p-4 w-full flex flex-col flex-wrap" data-hs-accordion-always-open >
    ...
    <button onClick={()=>navigate("/teacherDashboard/user")} class="py-2 px-2.5 bg-gray-300 text-sm text-gray-900 rounded-xl hover:bg-gray-100 dark:bg-neutral-700 dark:text-white w-[80px] h-[70px]">
